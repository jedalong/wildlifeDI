...
```{r message=FALSE}
spall <- ltraj2sf(does)                         # Turn all fixes into spatial points
sp1 <- conSpatial(doephas,type='point')               # Get points of all contacts
#Figure 3a
plot(spall['contact_pha')
plot(sp1,add=T)
```
...
#Figure 3c
sp3 <- conSpatial(doephas,type='line')
plot(spall,col='grey')
plot(sp1,add=T)
